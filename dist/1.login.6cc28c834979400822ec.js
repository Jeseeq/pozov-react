...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginForm = __webpack_require__(764);
	...
	var validateAndSignInUser = function validateAndSignInUser(values, dispatch) {
	  return new _promise2.default(function (resolve, reject) {
	    dispatch((0, _user.login)(values)).then(function (response) {
	      var data = response.payload.data;
	      if (response.payload.status !== 200) {
	        dispatch((0, _user.loginFailure)(response.payload));
	        // for redux-form
	        reject(data);
	      } else {
	        dispatch((0, _user.loginSuccess)(response.payload));
	        // for redux-form
	        resolve();
	      }
	    });
	...
	exports.default = (0, _reduxForm.reduxForm)({
	  ...
	  validate: validate
	}, mapStateToProps, mapDispatchToProps)(_LoginForm2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginForm = function (_Component) {
	  ...
	  function LoginForm() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LoginForm).apply(this, arguments));
	  }
	  ...
	  (0, _createClass3.default)(LoginForm, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'form-horizontal', onSubmit: handleSubmit(this.props.signIn.bind(this)) },
	          _react2.default.createElement(
	            'div',
...
//# sourceMappingURL=1.login.6cc28c834979400822ec.js.map