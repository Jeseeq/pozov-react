...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".form-container .fa-user{font-size:48px;margin:20px auto;display:block;text-align:center}.form-container form{border:1px solid #eee;border-radius:4px;padding:30px}.form-container header{display:block;font-size:20px;background:#ececec;padding:8px 30px;text-align:left}.form-container .form-group{margin-bottom:20px}.form-container .submit{margin-right:5px}.form-container .submit i{margin-right:2px}.form-container .submit a{margin-left:5px}", "", {"version":3,"sources":["/./src/routes/src/routes/Auth/Form.scss"],"names":[],"mappings":"AAAA,yBAEI,eAAgB,iBACY,cACb,iBACI,CALvB,qBAQI,sBAAuB,kBACJ,YACL,CAVlB,uBAaI,cAAe,eACC,mBACI,iBACF,eACD,CAjBrB,4BAoBI,kBAAoB,CApBxB,wBAuBI,gBAAkB,CAvBtB,0BAyBQ,gBAAkB,CAzB1B,0BA4BQ,eAAiB,CACpB","file":"Form.scss","sourcesContent":[".form-container {\r\n  .fa-user {\r\n    font-size: 48px;\r\n    margin: 20px auto 20px auto;\r\n    display: block;\r\n    text-align: center;\r\n  }\r\n  form {\r\n    border: 1px solid #eee;\r\n    border-radius: 4px;\r\n    padding: 30px;\r\n  }\r\n  header {\r\n    display: block;\r\n    font-size: 20px;\r\n    background: #ececec;\r\n    padding: 8px 30px;\r\n    text-align: left;\r\n  }\r\n  .form-group{\r\n    margin-bottom: 20px;\r\n  }\r\n  .submit {\r\n    margin-right: 5px;\r\n      i {\r\n        margin-right: 2px;\r\n      }\r\n      a {\r\n        margin-left: 5px;\r\n    }\r\n\r\n  }\r\n}\r\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SignupForm = __webpack_require__(769);
	  ...
	  return new _promise2.default(function (resolve, reject) {
	    dispatch((0, _validateUserFields.validateUserFields)(values)).then(function (response) {
	      ...
	      if (response.payload.status !== 200) {
	        ...
	        dispatch((0, _validateUserFields.validateUserFieldsSuccess)(response.payload));
	        resolve();
	      }
	    });
	  });
	...
	function validateAndSignup(values, dispatch) {
	  return new _promise2.default(function (resolve, reject) {
	    dispatch((0, _user.signup)(values)).then(function (response) {
	      var data = response.payload.data;
	      if (response.payload.status !== 200) {
	        dispatch((0, _user.signupFailure)(response.payload));
	        reject(data);
	      } else {
	        dispatch((0, _user.signupSuccess)(response.payload));
	        resolve();
	      }
	    });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SignupForm = function (_Component) {
	  ...
	  function SignupForm() {
	    ...
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(SignupForm).apply(this, arguments));
	  }
	  ...
	  (0, _createClass3.default)(SignupForm, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'col-xs-offset-2 col-xs-8 col-md-offset-3 col-md-6 form-container' },
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'form-horizontal', onSubmit: handleSubmit(signup) },
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group ' + (username.touched && username.error ? 'has-error' : '') },
	            _react2.default.createElement(
	              'label',
	              { htmlFor: 'username', className: 'control-label col-sm-4' },
	              'Імя користувача'
	            ),
	            _react2.default.createElement(
	              'div',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'label',
	              { htmlFor: 'password', className: 'control-label col-sm-4' },
	              'Пароль*'
	            ),
	            _react2.default.createElement(
	              'div',
...
//# sourceMappingURL=2.signup.6cc28c834979400822ec.js.map