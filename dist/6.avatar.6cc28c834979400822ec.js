...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChangeAvatar = __webpack_require__(784);
	...
	function validateAndChange(values, dispatch) {
	  ...
	  return new _promise2.default(function (resolve, reject) {
	    dispatch((0, _user.changeAvatar)(data)).then(function (response) {
	      var data = response.payload.data;
	      if (response.payload.status !== 200) {
	        dispatch((0, _user.changeAvatarFailure)(response.payload));
	        reject(data);
	      } else {
	        dispatch((0, _user.changeAvatarSuccess)(response.payload));
	        dispatch((0, _reduxForm.reset)('file'));
	        resolve();
	      }
	    });
	  });
	...
	}, mapStateToProps, mapDispatchToProps)(_ChangeAvatar2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChangeAvatar = function (_React$Component) {
	  (0, _inherits3.default)(ChangeAvatar, _React$Component);
	
	  function ChangeAvatar(props) {
	    (0, _classCallCheck3.default)(this, ChangeAvatar);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ChangeAvatar).call(this, props));
	  ...
	  (0, _createClass3.default)(ChangeAvatar, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      var _this2 = this;
	
	      var avatar = nextProps.fields.avatar;
	
	      if (avatar.value.length !== 0) {
	        (function () {
	          var reader = new FileReader();
	          var file = avatar.value[0];
	    ...
	    value: function render() {
	      ...
	      var avatar = _props.fields.avatar;
	      ...
	      var imageUrl = avatar.value[0] ? this.state.avatarUrl : '/uploads/avatar/320/' + fileName;
	      return _react2.default.createElement(
	        'div',
	        { classNameNameName: 'row' },
	        _react2.default.createElement(
	          'div',
	          { className: 'col-xs-offset-1 col-xs-10 col-md-offset-3 col-md-6' },
	          _react2.default.createElement(
	            'form',
	            ...
	            _react2.default.createElement(
	              ...
	              !avatar.value[0] ? _react2.default.createElement(
	                'span',
	                { className: 'btn btn-default btn-file' },
	                'Виберіть зображення',
	                _react2.default.createElement('input', (0, _extends3.default)({ type: 'file' }, avatar, { value: undefined }))
	              ) : _react2.default.createElement(
	                'span',
	                { className: 'avatar-btn' },
	                _react2.default.createElement(
	                  'button',
	                  { className: 'btn btn-default', type: 'submit', disabled: submitting },
	                  'Завантажити'
	                ),
	                _react2.default.createElement(
	                  'button',
	                  { className: 'btn btn-danger', onClick: resetForm },
	                  'Відмінити'
	                )
	              )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true) {
		...
		if(!content.locals) {
			module.hot.accept(786, function() {
				var newContent = __webpack_require__(786);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".btn-file{position:relative;overflow:hidden}.btn-file input[type=file]{position:absolute;top:0;right:0;min-width:100%;min-height:100%;font-size:100px;text-align:right;filter:alpha(opacity=0);opacity:0;background:#fff;cursor:inherit;display:block}.user-profile-picture{min-height:150px;max-height:150px}.avatar-btn button{margin-right:5px}", "", {"version":3,"sources":["/./src/routes/Settings/src/routes/Settings/ChangeAvatar/ChangeAvatar.scss"],"names":[],"mappings":"AAAA,UACE,kBAAmB,eACF,CAClB,2BAEC,kBAAmB,MACZ,QACE,eACO,gBACC,gBACA,iBACC,wBACL,UACF,gBACO,eACF,aACD,CAChB,sBAEC,iBAAkB,gBACA,CACnB,mBAIG,gBAAkB,CACnB","file":"ChangeAvatar.scss","sourcesContent":[".btn-file {\r\n  position: relative;\r\n  overflow: hidden;\r\n}\r\n.btn-file input[type=file] {\r\n  position: absolute;\r\n  top: 0;\r\n  right: 0;\r\n  min-width: 100%;\r\n  min-height: 100%;\r\n  font-size: 100px;\r\n  text-align: right;\r\n  filter: alpha(opacity=0);\r\n  opacity: 0;\r\n  background: white;\r\n  cursor: inherit;\r\n  display: block;\r\n}\r\n.user-profile-picture {\r\n  min-height: 150px;\r\n  max-height: 150px;\r\n}\r\n.avatar-btn {\r\n\r\n  button {\r\n    margin-right: 5px;\r\n  }\r\n}\r\n"],"sourceRoot":"webpack://"}]);
...
//# sourceMappingURL=6.avatar.6cc28c834979400822ec.js.map